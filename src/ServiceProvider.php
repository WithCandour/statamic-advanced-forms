    ...
    public function bootNav(): self
    {
        Nav::extend(function ($nav) {
            $nav->tools('Advanced Forms')
                ...
                ->children([
                    $nav->item(__('advanced-forms::general.settings'))
                        ->route('advanced-forms.settings.index')
                        ->can('view advanced forms settings')
                ]);
        });
        ...
        Permission::group('advanced-forms', __('advanced-forms::messages.title'), function () {
            Permission::register('access advanced forms', function ($permission) {
                $permission->children([
                    ...
                    Permission::make('view advanced forms settings')
                        ->label('View settings'),
