import CreateForm from './components/cp/forms/CreateForm'
...
import NotificationCreateForm from './components/cp/notifications/CreateForm'
...
Statamic.booting(() => {
    // CP views
    Statamic.component('advanced-forms-create-form', CreateForm)
    ...
    Statamic.component('advanced-forms-notification-create-form', NotificationCreateForm)
